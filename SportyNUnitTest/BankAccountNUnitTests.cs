...
namespace SportyNUnitTest
{
    ...
    public class BankAccountNUnitTests
    {
        ...
        [Test]
        public void BankDeposit_Add100_ReturnTrues()
        {
        ...
        public void BankWithdraw_Withdraw300With200Balance_ReturnsFalse(int balance, int withdraw)
        {
            ...
            logMock.Setup(u => u.LogBalanceAfterWithdrawal(It.IsInRange<int>
                (int.MinValue, -1, Moq.Range.Inclusive))).Returns(false);
        ...
        public void BankLogDummy_LogMockString_ReturnTrue()
        {
            ...
            logMock.Setup(u => u.MessageWithReturnStr
            (It.IsAny<string>())).Returns((string str) => str.ToLower());

            Assert.That(logMock.Object.MessageWithReturnStr("HELLo"), 
                Is.EqualTo(desiredOutput));
        }
